...
using Soenneker.Sonarr.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Sonarr.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Sonarr:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/Sonarr/Sonarr/develop/src/Sonarr.Api.V3/openapi.json";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c SonarrOpenApiClient -n {Constants.Library}",
